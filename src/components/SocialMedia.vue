...
export default {
  ...
  methods: {
    ...
    getAllUsers() {
      const url = 'http://54.166.226.221:5000/get_users';
      axios.get(url)
          .then(response => {
    ...
    getUserFriendships() {
      const url = `http://54.166.226.221:5000/get_friendships/${this.userID}`;
      axios.get(url)
          .then(response => {
            if (response.status === 200) {
    ...
    sendFriendRequest(userId) {
      const url = `http://54.166.226.221:5000/add_friend/${this.userID}/${userId}`;
      axios.post(url)
          .then(response => {
    ...
    cancelFriendRequest(userId) {
      const url = `http://54.166.226.221:5000/remove_friend/${this.userID}/${userId}`;
      axios.delete(url)
          .then(response => {
            if (response.status === 200) {
              this.getUserFriendships();
    ...
    createPost() {
      ...
      const url = `http://54.166.226.221:5000/create_post`;
    ...
    getAllPosts() {
      ...
      const url = `http://54.166.226.221:5000/view_my_posts/${this.userID}`;
    ...
    respondToFriendRequest(userId, action) {
      ...
      const url = `http://54.166.226.221:5000/respond_friend_request/${this.userID}/${userId}`;
    ...
    fetchSentMessages() {
      this.selectedMessageCategory = 'sent';
      const url = `http://54.166.226.221:5000/sent_messages/${this.userID}`;
      axios.get(url)
          .then(response => {
            if (response.status === 200) {
    ...
    fetchReceivedMessages() {
      ...
      const url = `http://54.166.226.221:5000/received_messages/${this.userID}`;
      axios.get(url)
          .then(response => {
            if (response.status === 200) {
    ...
    sendMessage() {
      const url = 'http://54.166.226.221:5000/send_message';
      axios.post(url, {
